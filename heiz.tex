...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%
      \put(5816,1317){\makebox(0,0)[r]{\strut{}$I_\text{H}=2$A}}%
      \csname LTb\endcsname%
      \put(5816,1097){\makebox(0,0)[r]{\strut{}$I_\text{H}=1.9$A}}%
      \csname LTb\endcsname%
      \put(5816,877){\makebox(0,0)[r]{\strut{}$I_\text{H}=1.8$A}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{heiz}}%
    \gplfronttext
  \end{picture}%
\endgroup
