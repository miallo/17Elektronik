...
p 'heiz18.dat' u (log($3+1.38)):(log($2/1000)) t'$I_\text{H}=\SI{1.8}{\ampere}$' lt 1, f(x) lt 1 notitle,'heiz19.dat' u (log($3+1.62)):(log($2/1000)) t'$I_\text{H}=\SI{1.9}{\ampere}$' lt 2, g(x) lt 2 notitle, 'heiz2.dat' u (log($3+1.9)):(log($2/1000)) t'$I_\text{H}=\SI{2}{\ampere}$' lt 3, h(x) lt 3 notitle
